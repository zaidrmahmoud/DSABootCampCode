...
public class KunalFourth {
    static int x = 10; // INFO: This is a global variable, it can be accessed anywhere in the class because it was declared outside the main method
    static int y = 20; // NOTE: This is shadowed by the local variable 'y' in the main method
    public static void main(String[] args) {
        Scanner in = new Scanner(System.in);

        int y = 30; // NOTE: This will shadow the global variable 'y' which is the higher level scope
        // INFO: THE HIGHER LEVEL SCOPE IS ALWAYS SHADOWED BY THE LOWER LEVEL SCOPE
        ...
        int num1, num2, sum; // NOTE: Multiple variables can be declared in a single line
        ...
        a = 10;
        {
            // HACK: THIS IS CALLED BLOCK SCOPING
        ...
        int c = 9; // BUG: NOT ERROR BECAUSE ANY VARIABLE DECLARED INSIDE A BLOCK CANNOT BE ACCESSED OUTSIDE THE BLOCK, SO 'c' CAN BE REINITIALIZED
        System.out.println(a); // This will print 100 because the value of a was changed to 100 inside the block
        // System.out.println(c); // BUG: ERROR BECAUSE C IS NOT ACCESSIBLE OUTSIDE THE BLOCK
        {
            ...
            for (int i = 0; i < 5; i++) { // INFO: ANY VARIABLE DECLARED INSIDE A LOOP CANNOT BE ACCESSED OUTSIDE THE LOOP, SO 'i' CANNOT BE ACCESSED OUTSIDE THE LOOP
                ...
                a = 20; // NOTE: 'a' CAN BE ACCESSED OUTSIDE THE LOOP BECAUSE IT WAS DECLARED OUTSIDE THE LOOP
            }
            // System.out.println(num); // BUG: ERROR BECAUSE 'num' IS NOT ACCESSIBLE OUTSIDE THE LOOP, EVEN IF IT IS DECLARED IN THE SAME BLOCK
        }
    }
    // INFO: IF YOU DO NOT KNOW HOW MANY ARGUMENTS ARE GOING TO BE PASSED, YOU CAN USE VARARGS, THIS IS AN EXAMPLE:
    static void varargs(int ...v) {
        System.out.println(Arrays.toString(v));
    }
    // INFO: YOU CAN ALSO USE VARARGS WITH DIFFERENT TYPES OF ARGUMENTS, THIS IS AN EXAMPLE:
    static void varargs(int a, int b, String ...v) {
        System.out.println(Arrays.toString(v));
    }
    // INFO: HOWEVER, IT ALWAYS HAS TO BE THE LAST PARAMETER IN THE METHOD
    // static void varargs(String ...v, int a) {}
        // BUG: THIS IS AN ERROR BECAUSE THE VARARGS PARAMETER IS NOT THE LAST PARAMETER
}